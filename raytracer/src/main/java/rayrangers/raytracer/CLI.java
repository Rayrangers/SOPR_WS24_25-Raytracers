...
/**
 * Prototype of the raytracer utilizing the JSON parser for the scene
 * specification based on Quicktype.
 */
public class CLI {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            System.err.println("Error: No arguments provided. Please specify the scene path and output path.");
            System.exit(1);
        }
        ...
        try {
            scene = SceneParser.parseScene(scenePath);
